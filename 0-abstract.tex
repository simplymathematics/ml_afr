...
By using accelerated failure rate models, worst-case examples, and a cost-aware analysis, \cm{our method} can precisely and accurately reject a particular model change during routine model training procedures rather than relying on real-world deployment.
%  Conclusion  
