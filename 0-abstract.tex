...
By using accelerated failure rate models, worst-case examples, and a cost-aware analysis, \cm{our approach} can precisely and accurately reject a particular model change during routine model training procedures rather than relying on real-world deployment, \cm{expensive formal methods, or the simulation of many interconnected software and hardware components}.
%  Conclusion  
