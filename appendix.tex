...
\begin{figure}[h!]
    ...
    \begin{subfigure}
        \centering
        \includegraphics[trim={0 20pt 0 10pt},clip,width=.4\textwidth]{plots/def_param_vs_accuracy.eps}
    \end{subfigure}
    \begin{subfigure}
        \centering
        \includegraphics[trim={0 20pt 0 10pt},clip,width=.4\textwidth]{plots/atk_param_vs_accuracy.eps}
    \end{subfigure}
