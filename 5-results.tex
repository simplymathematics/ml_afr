...
\begin{figure}
	% \begin{subfigure}
	% \centering
    \includegraphics[width=.45\textwidth]{cifar100/log_normal_layers_partial_effect.eps}
    \label{fig:layers}
    % \end{subfigure}
 %    \begin{subfigure}
	% \centering
 %    \includegraphics[width=.45\textwidth]{cifar100/log_normal_epochs_partial_effect.eps}
 %    \label{fig:epochs}
 %    \end{subfigure}
