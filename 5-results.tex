...
%         \centering
%         \includegraphics[width=\textwidth]{cifar100_def_param_vs_accuracy.eps}
%     \end{subfigure}
%     \begin{subfigure}{0.45\textwidth}
%         \centering
%         \includegraphics[width=\textwidth]{cifar100_atk_param_vs_accuracy.eps}
%     \end{subfigure}
...
\end{figure*}
\input{cifar100_aft_comparison}
% \input{mnist_aft_comparison}
\begin{figure}
    % \begin{subfigure}
    %     \input{cifar100_aft_comparison}
    % \end{subfigure}
    \centering\includegraphics[width=.5\textwidth]{cifar100_log_normal_layers_partial_effect.eps}
